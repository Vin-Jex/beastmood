  ...
  return (
    <ul className='specials-nav'>
      <li
        ...
        className={` ${activeClass === 1 ? "specials-active" : ""}`}
      >
        <p>Recomended</p>
      ...
      <li
        ...
        className={` ${activeClass === 2 ? "specials-active" : ""}`}
      >
        <p>Favorite&apos;s</p>
        <ArrowForwardIos className='icon' />
      </li>
      ...
      <li
        ...
        className={` ${activeClass === 3 ? "specials-active" : ""}`}
      >
        <p>Completed</p>
        <ArrowForwardIos className='icon' />
      </li>
      <li
        ...
        className={` ${activeClass === 4 ? "specials-active" : ""}`}
      >
        <p>Coming Up</p>
        <ArrowForwardIos className='icon' />
      </li>
