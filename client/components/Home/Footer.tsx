...
const Footer = () => {
  return (
    <footer className='pt-10 px-4 md:px-12 bg-main2-brand flex flex-col space-y-12 divide-y divide-blue-300 font-[Montserrat]'>
      ...
      <div className='w-full flex flex-col-reverse sm:flex-row justify-between px-0 md:px-14 py-4 sm:py-10'>
        <span className='text-dark text-base sm:text-base my-2 sm:my-0'>&copy; {new Date().getFullYear()}, All rights reserved</span>
