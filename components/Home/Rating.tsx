...
const originalArray = [0, 0, 0, 0, 0];
let copyArray = [...originalArray]; // a copy of the original array

const userInput = 5;

console.log("Number: ", originalArray[1]);

copyArray[userInput - 1] = copyArray[userInput - 1] + 1;
