...
const parseExpressPath = function (expressPathRegExp, params) {
    ...
    const parsedPath = expressPathRegExpExec === null || expressPathRegExpExec === void 0 ? void 0 : expressPathRegExpExec[1].replace(/\\\//g, '/');
    return parsedPath;
};
...
const parseStack = function (stack, basePath, endpoints) {
    stack.forEach((stackItem) => {
        ...
        if (stackItem.route) {
            ...
            const isExpressPathRegexp = regExpToParseExpressPathRegExp.test(((_a = stackItem.regexp) === null || _a === void 0 ? void 0 : _a.toString()) || '');
